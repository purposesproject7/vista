...
const FacultyCreation = ({ school, programme }) => {
  ...
  const handleUpload = useCallback(async () => {
    ...
    try {
      ...
      const enrichedData = facultyData.map((faculty) => ({
        ...faculty,
        ...faculty,
        school: school, // Use prop
        department: programme, // Use prop (mapped to department)
  ...
  const handleRemoveManualFaculty = useCallback(
    (id) => {
  ...
  const handleRemoveUploadedFaculty = useCallback(
    (employeeId) => {
      setUploadedFaculty((prev) =>
        prev.filter((f) => f.employeeId !== employeeId)
      );
      showToast("Faculty member removed", "info");
    },
    [showToast]
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600 mt-1">
                Upload multiple faculty members via Excel
              </p>
            </button>
            <button
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-700 space-y-1 list-disc list-inside">
                  ...
                  <li>
                    Fill in faculty details (Employee ID, Name, Email, Phone
                      ...
                      {uploadedFaculty.map((faculty) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 whitespace-nowrap text-right text-sm">
                            <button
                              onClick={() =>
                                handleRemoveUploadedFaculty(faculty.employeeId)
                              }
          ...
          <Card>
            ...
            <div className="space-y-4">
              <Input
                ...
                onChange={(e) =>
                  handleManualFormChange("employeeId", e.target.value)
                }
              ...
              <Input
                ...
                onChange={(e) =>
                  handleManualFormChange("emailId", e.target.value)
                }
              ...
              <Input
                ...
                onChange={(e) =>
                  handleManualFormChange("phoneNumber", e.target.value)
                }
              ...
              <Input
                ...
                onChange={(e) =>
                  handleManualFormChange("specialization", e.target.value)
                }
              ...
              <div className="pt-4 border-t border-gray-200 flex gap-3">
                ...
                <Button onClick={() => setActiveMode(null)} variant="secondary">
                  Back
                </Button>
              </div>
            </div>
                      ...
                      {manualFaculty.map((faculty) => (
                        <tr key={faculty.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 whitespace-nowrap text-right text-sm">
                            <button
                              onClick={() =>
                                handleRemoveManualFaculty(faculty.id)
                              }
                              className="text-red-600 hover:text-red-800 font-medium"
                            >
                              Remove
