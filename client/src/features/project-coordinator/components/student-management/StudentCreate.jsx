...
const StudentCreate = () => {
  ...
  const validateManualForm = () => {
    ...
    const isDuplicate =
      manualStudents.some((s) => s.regNo === manualForm.regNo) ||
          ...
          >
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                Bulk upload students using an Excel file
              </p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-700 space-y-1 list-disc list-inside">
                  ...
                  <li>
                    Fill in student details (Registration Number, Name, Email
                    ID)
                  </li>
                  <li>
                    School, Department, and Academic Year will be auto-filled
                  </li>
                      ...
                      {uploadedStudents.map((student, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 whitespace-nowrap text-right text-sm">
                            <button
                              onClick={() =>
                                handleRemoveStudent(index, "upload")
                              }
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Input
                  ...
                  onChange={(e) =>
                    handleManualFormChange("regNo", e.target.value)
                  }
                    ...
                    <Button
                      onClick={async () => {
                        try {
                          ...
                          // Import API dynamically if not at top, or assume imported
                          const { bulkUploadStudents } = await import(
                            "../../services/coordinatorApi"
                          );
                          ...
                          if (response.success) {
                            showToast(
                              response.message || "Students saved successfully",
                              "success"
                            );
                            setManualStudents([]);
                            setUploadedStudents([]);
                            ...
                            showToast(
                              response.message || "Failed to save students",
                              "error"
                            );
                          }
                        } catch (error) {
                      ...
                      {manualStudents.map((student, index) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 whitespace-nowrap text-right text-sm">
                            <button
                              onClick={() =>
                                handleRemoveStudent(index, "manual")
                              }
                              className="text-red-600 hover:text-red-800 font-medium"
                            >
                              Remove
