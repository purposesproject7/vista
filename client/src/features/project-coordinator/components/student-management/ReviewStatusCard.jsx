// src/features/project-coordinator/components/student-management/ReviewStatusCard.jsx
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        {hasReviews && (
          <span className="text-xs text-gray-600">
            {approvedCount} / {reviewStatuses.length} reviews approved
          </span>
        )}
      </div>
      ...
      {hasReviews ? (
        <div className="space-y-2">
          <div className="flex items-center justify-between py-2 px-3 bg-orange-50 rounded-lg border border-orange-200 mb-3">
            ...
            <span className="text-xs text-orange-600">{approvedCount}/{reviewStatuses.length} approved</span>
          </div>
          ...
          {reviewStatuses.map((review, index) => {
            ...
            return (
              ...
              >
                <div>
                  <span className="text-sm font-medium text-gray-700">{review.faculty}</span>
                  {review.date && (
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between py-2 px-3 bg-orange-50 rounded-lg border border-orange-200 mb-3">
            <span className="text-xs font-medium text-orange-700">Approval Status</span>
            <span className="text-xs text-orange-600">0 reviews approved</span>
          </div>
