// src/features/admin/components/faculty-management/FacultyBulkUploadModal.jsx
...
const FacultyBulkUploadModal = ({ isOpen, onClose, onUpload, filters }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Enrich data with filter information
      ...
      if (result.success) {
        setUploadStatus({ 
          success: true, 
          message: `Successfully uploaded ${parsedData.length} faculty members` 
        });
      ...
      setUploadStatus({ 
        success: false, 
        message: error.response?.data?.message || error.message || 'Failed to upload faculty' 
      });
    } finally {
        ...
        {filters && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-xs text-blue-600 mt-2">
              All faculty will be associated with this academic context.
            </p>
          </div>
        )}
...
export default FacultyBulkUploadModal;
