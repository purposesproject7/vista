...
const FacultyDashboard = () => {
  ...
  const { active, deadlinePassed, past, loading, error, refetch } = useFacultyReviews(filters);
  ...
  const allFiltersSelected = filters.year && filters.school && filters.programme && filters.type;
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        {!allFiltersSelected ? (
          <div className="bg-white rounded-xl p-8 text-center border border-gray-200 shadow-sm">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-2">Complete All Filters</h3>
            <p className="text-gray-600 text-sm">Select all four filters above to view reviews</p>
          </div>
        ) : loading ? (
