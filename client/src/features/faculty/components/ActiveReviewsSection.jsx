...
const ActiveReviewsSection = ({ reviews, onEnterMarks }) => {
  ...
  return (
    <div data-tutorial="active-reviews">
      ...
      <div className="space-y-3">
        {reviews.map((review) => {
          ...
          return (
            <div
              key={review.id}
              className="bg-white rounded-xl shadow-md border-2 border-blue-200 overflow-hidden hover:shadow-lg transition-all"
            >
              {/* Review Header */}
              <div
                    ...
                    {review.teams?.map((team) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          data-tutorial="enter-marks-button"
                        >
                          {team.marksEntered
                            ? "✏️ Edit Marks"
                            : "📝 Enter Marks"}
