...
const FilterPanel = ({ filters, onFilterChange }) => {
  ...
  const steps = [
    ...
    { key: 'school', label: 'School', options: schoolOptions, enabled: !!filters.year },
    { key: 'programme', label: 'Programme', options: programmeOptions, enabled: !!filters.school },
    ...
    <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-4 shadow-lg border-2 border-blue-500 mb-4 sticky top-0 z-40">
      ...
      <div className="grid grid-cols-4 gap-3">
        {steps.map((step) => {
          ...
          return (
            <div key={step.key} className={isLocked ? 'opacity-50' : ''}>
              <Select
                label={step.label}
